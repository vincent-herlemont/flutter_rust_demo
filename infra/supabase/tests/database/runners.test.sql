...
SELECT throws_like( $$ INSERT INTO public.runners (uri) VALUES ('http://example.com') $$,
        '%new row violates row-level security policy for table "runners"');
CALL auth.logout();
